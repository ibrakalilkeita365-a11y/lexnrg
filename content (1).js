...
const LEXNRG = {
  ...
  stats: [
    { num: "69 951 MW", label: "Capacité ENR installée en Afrique en 2024 — doublée en 10 ans (IRENA 2025)" },
    { num: "600M",      label: "Africains sans accès à l'électricité, pour 3,3% seulement des émissions mondiales (Mo Ibrahim)" },
    { num: "11%",       label: "Seulement du potentiel hydraulique africain exploité — 1 100 GW encore disponibles" },
    { num: "5%",        label: "Des émissions mondiales pour 19% de la population mondiale — le paradoxe africain" }
  ],
  ...
  pays: [
    {
      ...
      modal: {
        ...
        titre: "🇲🇦 Maroc",
        sous_titre: "ERI Score ★★★★★ — Modèle de référence ENR africain, 52% ENR installé en 2024",
        stats: [
          { num: "52%",    lbl: "Part ENR 2024" },
        ...
        sections: [
          {
            ...
            type: "liste",
            items: [
              "<strong>Loi 13-09</strong> (2010) — Loi fondatrice ENR. Ouvre la production privée aux IPPs. Crée un marché hybride : petit marché ouvert + marché régulé avec ONEE comme acheteur unique.",
          ...
          },
          {
            titre: "Acteurs clés",
            type: "tags",
            items: ["MASEN — Agence ENR", "ANRE — Régulateur", "ONEE — Réseau national (acheteur unique)"]
          },
          {
            titre: "Projet phare",
            type: "texte",
          ...
          {
            titre: "⚠️ Limites institutionnelles à surveiller (Bruegel 2025)",
            type: "liste",
            items: [
              "<strong>Compétition MASEN / ONEE / Ministère</strong> — Principal obstacle interne à l'accélération. ONEE reste acheteur unique exclusif des projets MASEN, limitant la flexibilité du marché.",
              "<strong>Intégration industrielle partielle</strong> — Seulement 25-45% de contenu local dans les projets solaires. Turbines, panneaux PV et onduleurs encore importés.",
              "<strong>Fermeture usine Siemens Gamesa Maroc (2022)</strong> — Choc sur la capacité industrielle locale ENR."
            ]
          },
          {
            titre: "Hydrogène vert — Projet Power-to-X",
            type: "texte",
            contenu: "1er grand projet industriel H2 vert marocain. <strong>100 MW ENR</strong>, co-développé avec le gouvernement allemand + MASEN. Commissioning prévu 2025. Positionnement stratégique vers l'export vers l'Europe."
          },
          {
            titre: "⚠️ Projet Xlinks gelé (juin 2025)",
            type: "texte",
            contenu: "Le projet <strong>Xlinks Maroc → UK (3 600 MW, câble sous-marin)</strong> a été gelé en juin 2025 après que le gouvernement britannique a annoncé ne pas soutenir le projet. Signal négatif pour les grands projets d'export ENR transocéaniques."
          }
        ],
    ...
    },
    {
      ...
      modal: {
        ...
        titre: "🇰🇪 Kenya",
        sous_titre: "ERI Score ★★★★★ — 7ème pays mondial pour le ratio ENR/consommation totale (SRWE 2025)",
        stats: [
          { num: "93%",      lbl: "Électricité ENR" },
          { num: "41%",      lbl: "Part géothermie (2021)" },
        ...
        sections: [
          {
            ...
            type: "texte",
            contenu: "La <strong>Geothermal Development Company</strong> assume le risque de forage amont (le plus risqué). Les IPPs privés construisent uniquement la centrale de conversion. Résultat : IRR 15%, financement en 18 mois. Ce modèle de dérisquage public-privé est directement transposable à toute l'Afrique."
          },
          {
            titre: "Mix ENR détaillé",
            type: "liste",
            items: [
              "<strong>Géothermie : 41%</strong> de la génération totale (2021) — stabilité de base, élimine l'intermittence solaire/éolien",
              "<strong>Hydraulique : ~30%</strong> — barrages Seven Forks sur la rivière Tana",
              "<strong>Éolien : Lake Turkana Wind Power</strong> — 310 MW (IRENA 2024), plus grande ferme éolienne d'Afrique, opérationnelle depuis 2018, 700 MUSD (BAD + BEI + privés)",
              "<strong>Solar off-grid</strong> — modèle pay-as-you-go M-KOPA : financement solaire résidentiel via mobile money, réplicable dans 20+ pays africains"
            ]
          },
          {
            titre: "Réformes 2024-2026",
            type: "liste",
            items: [
              "<strong>Energy Act 2019</strong> — EPRA indépendant, PDG nommé par concours (meilleur régulateur ENR d'Afrique subsaharienne)",
              ...
              "<strong>Unbundling KPLC en cours (2025-2026)</strong> — Séparation production/transport/distribution de Kenya Power pour réduire coûts et inefficacités"
            ]
          }
        ],
        cta: "Accéder à la fiche complète →"
    ...
    },
    {
      ...
      region: "Afrique Centrale",
      eri: 2,
      tags_carte: ["Grand Inga 45GW", "70% cobalt mondial"],
      modal: {
        eyebrow: "Fiche Pays · Afrique Centrale",
        titre: "🇨🇩 RD Congo",
        sous_titre: "ERI Score ★★☆☆☆ — Le paradoxe le plus extrême du continent : 45 GW de potentiel hydraulique, 22% d'électrification",
        stats: [
          { num: "2 700 MW", lbl: "Capacité installée" },
          { num: "22%",      lbl: "Taux électrification" },
          { num: "70%",      lbl: "Cobalt mondial produit ici" }
        ],
        sections: [
          {
            titre: "Grand Inga — Le plus grand potentiel inutilisé au monde",
            type: "liste",
            items: [
              "<strong>Inga I (351 MW, 1972) + Inga II (1 424 MW, 1982)</strong> fonctionnent à seulement 40% de leur capacité installée faute de maintenance",
              "<strong>Inga III (4,8 GW)</strong> toujours en phase de conception — bloqué depuis plus de 20 ans",
              "<strong>Grand Inga complet : jusqu'à 45 GW</strong> — plus grande installation hydroélectrique mondiale si construite. Estimation : 80 Mds USD minimum",
              "Obstacle central : le <strong>Fleuve Congo n'a pas de traité de partage</strong> des eaux entre les pays riverains — vide juridique international critique"
            ]
          },
          {
            titre: "Le paradoxe cobalt",
            type: "texte",
            contenu: "La RDC produit <strong>plus de 70% du cobalt mondial</strong> — minerai clé pour toutes les batteries de véhicules électriques et de stockage ENR. Le pays alimente la transition verte mondiale mais n'arrive pas à s'électrifier lui-même. En 2025, le gouvernement a imposé un moratoire sur les exportations de cobalt pour forcer la transformation locale."
          },
          {
            titre: "⚠️ Vides juridiques critiques",
            type: "liste",
            items: [
              "Aucune loi ENR dédiée aux IPPs — chaque projet nécessite une négociation gré à gré",
              "Pas de PPA standardisé pour projets solaires off-grid",
              "Infrastructure de 4 Mds USD/an de déficit — routes, ports, lignes de transmission",
              "DRC + Zambie : Corridor de Lobito (50 Mds USD USA) pour créer une chaîne de valeur batteries/VE intégrée — premier signal institutionnel positif"
            ]
          },
          {
            titre: "Acteurs clés",
            type: "tags",
            items: ["SNEL — Société nationale électricité", "ARE — Autorité régulation", "FPI — Fonds promotion industrie"]
          }
        ],
        cta: "Accéder à la fiche complète →"
      }
  ...
  social: [
    ...
    { label: "in LinkedIn",        url: "https://www.linkedin.com/in/ibrahima-kalil-keita-a53000257" },
